def line_geometry_checks( gdf ):
    """
    Check the geometries in a GeoDataFrame are LineStrings

    Runs a series of checks on a GeoDataFrame to ensure that
    it contains LineStrings.
